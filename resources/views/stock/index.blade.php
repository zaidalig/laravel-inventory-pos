...
</tbody></table></div>@include('components.table-pagination', ['paginator'=>$movements, 'sorts'=>['created_at'=>'Created','quantity'=>'Qty','type'=>'Type']])</div>
@endsection
